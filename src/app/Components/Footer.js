...
function Footer() {
    return (
        <footer
            className="w-full bg-red-800 flex flex-wrap
                        justify-center footerBG pt-[6%]"
        >
            <section className="flex justify-center flex-wrap">
                <div className="flex flex-col w-[40vw] justify-center">
                    <h1 className="headingfoot font-mono text-center">SIGUENOS EN NUESTRAS REDES SOCIALES</h1>
                    <div className="redesociales flex justify-center gap-[10%] mb-[2%]">
                        <Link href={"https://whatsapp.com"} target="Blank">
                            <svg viewBox="0 0 256 259" className="socialLinks" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid">
                                <path
                        ...
                        <Link href={"https://facebook.com"} target="Blank">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 36 36" fill="url(#a)" className="socialLinks">
                                <defs>
                        ...
                        <Link href={"https://instagram.com"} target="Blank">
                            <svg xmlns="http://www.w3.org/2000/svg" className="socialLinks" preserveAspectRatio="xMidYMid" viewBox="0 0 256 256">
                                <path
                                    fill="#fff"
                    ...
                    <p className="text-center paragraffoot">puntacanafun@gmail.com</p>
                </div>
